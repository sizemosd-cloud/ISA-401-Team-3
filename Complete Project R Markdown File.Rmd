...
# Create a table that pairs player names with their salaries, remove duplicate players so each appear only once, and then display the first few rows of the cleaned salary dataset.
...
# round the WAR values and keep only the player name and WAR columns, remove duplicate players, and then return the number of rows in the cleaned dataset.
